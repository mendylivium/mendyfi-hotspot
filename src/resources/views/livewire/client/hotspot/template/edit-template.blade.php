    ...
    <div class="col-lg-8">
        <div class="card shadow mb-4">
            <div class="card-header d-flex justify-content-between py-3">
                <h6 class="m-0 text-primary">Edit Voucher Template</h6>
            </div>
            <div class="card-body">
                <form
                    wire:submit.prevent="save($('#templateName').val(), cssTemplate.getValue(), htmlTemplate.getValue())">
                    <div class="form-group">
                        ...
                        <input type="text" id="templateName" class="form-control"placeholder="Enter Template Name"
                            value="{{ $templateName }}" autocomplete="off">
                        @error('templateName')
