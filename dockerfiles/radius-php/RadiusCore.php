    ...
    function processRadiusPacket(SocketServer $server, $data, $clientInfo)
    {
        ...
        switch($radiusData['code']) {
            ...
            case 1:
                ...
                $this->log("Dynamic is " . $dynamicSecret);
                    ...
                    switch($clientAttributes['Acct-Status-Type']) {
                        case "Start":
                            if (is_callable($this->acctStart)) {
                                ...
                                [$accessResponse , $radiusResponse, &$dynamicSecret] = call_user_func($this->acctStart, $clientAttributes);                    
                            } else {
                            ...
                            case "Stop":
                                if (is_callable($this->acctStop)) {
                                    ...
                                    [$accessResponse , $radiusResponse, &$dynamicSecret] = call_user_func($this->acctStop, $clientAttributes);                    
                                } else {
                            ...
                            case "Interim-Update":
                                if (is_callable($this->acctInterim)) {
                                    ...
                                    [$accessResponse , $radiusResponse, &$dynamicSecret] = call_user_func($this->acctInterim, $clientAttributes);                    
                                } else {
